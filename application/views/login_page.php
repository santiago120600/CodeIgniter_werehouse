...
<head>
    ...
    <link href="<?=base_url("resources/vendor/fontawesome-free/css/all.css");?>" rel="stylesheet" type="text/css">
    <link
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <?=form_open('index.php/login/auth', array('class'=>'user'));?>
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user"
                                                name="pEmail" aria-describedby="emailHelp"
